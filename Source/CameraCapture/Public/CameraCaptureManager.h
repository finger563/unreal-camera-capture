...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Capture", meta = (EditCondition = "bAutoStartCaptureOnBeginPlay", DisplayName = "Auto Start Serialization On Begin Play"))
